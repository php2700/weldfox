...
const Header = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 z-50 w-full bg-white  text-secondary-foreground py-2 px-6 text-xs md:text-sm">
      ...
      {/* Main Header */}
      <header className="sticky top-0 z-[4000] bg-white backdrop-blur-md shadow-sm">
